program extract
  ...
  OPEN(unit=12,file='error_all',form='formatted',status='unknown')
  OPEN(unit=13,file='error_Linfty',form='formatted',status='unknown')
  OPEN(unit=14,file='error_rates',form='formatted',status='unknown')
  READ(10,*) nb_fich
  DO i = 1, nb_fich
     READ(10,*) fich
     ...
     ELSE
        ...
        WRITE(13,*) err1
        WRITE(14,*) log(err0/err1)/log(i1/float(i0))
     END IF
  END DO
